...
- `driver`: the name of the OS's device driver _‹vulkan-only›_
...
The optional `matte` argument accepts a color-string specifying the background that should be drawn _behind_ the canvas in the exported image. Any transparent portions of the image will be filled with the matte color.
